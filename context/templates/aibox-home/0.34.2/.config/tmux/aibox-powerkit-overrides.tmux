...
# render pass.
set -g pane-border-style "fg=#A0A0A0,bg=#101010"
set -g pane-active-border-style "fg=#FFC799,bg=#101010"
set -g pane-border-indicators both
set -g pane-border-format "#[bg=#101010]#{?pane_active,#[fg=#FFC799]#[bold],#[fg=#E7E7E7]#[dim] } #{?client_prefix,PREFIX,NORMAL} #{pane_title} #{pane_current_command} #[bg=#101010,fg=#101010] "
