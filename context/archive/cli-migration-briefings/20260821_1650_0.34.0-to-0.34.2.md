...
**Status:** pending
**aibox CLI:** v0.34.0 → v0.34.2
**processkit:** v0.28.8

## Summary

aibox has been updated from v0.34.0 to v0.34.2. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.34.0 and v0.34.2 is listed below.                  Review each; treat entries tagged as breaking as action items.
