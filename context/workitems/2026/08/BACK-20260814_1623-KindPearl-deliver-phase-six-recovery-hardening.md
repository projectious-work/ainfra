...
spec:
  ...
  description: 'Implement the complete normative Phase 6 scope: reviewed destroy plans
    and exact-plan application, destructive evidence and independent teardown verification
    boundaries, interruption recovery and status guidance, retained run-log browsing,
    binding and redaction hardening, cache defenses, negative security fixtures, documentation,
    and a final requirements sweep. Keep the roadmap phase in progress until v1.0.0-alpha.6
