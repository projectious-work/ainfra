...
spec:
  ...
  description: 'Implement GitHub issue #1 through the six approved delivery milestones.
    Source: https://github.com/projectious-work/ainfra-templates/issues/1. Planning
    discussion: DISC-20260724_1719-JollyWillow-what-implementation-sequence-and-technical-boundaries.
    Done means the versioned contracts, thin Python/uv CLI, Hetzner Kubernetes-ready
